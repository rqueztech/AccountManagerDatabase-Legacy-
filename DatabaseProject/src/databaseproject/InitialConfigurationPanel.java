...
class InitialConfigurationPanel extends JPanel {
	/**
	 * 
	 */
	...
	InitialConfigurationPanel(AdministratorFunctions administratorFunctions, PanelCentral panelCentral) {
	...
	public void goBackFunction() {
		this.panelCentral.showCurrentSelectedPanel(PanelType.INITIAL_CONFIGURATION);
	}
